          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-6">
                St. Mary's School was established in 1965 by a group of visionary educators and community leaders 
                who recognized the need for quality education in our region. What started as a small institution 
                with just 50 students has grown into one of the most respected schools in Kenya.
              </p>
              <p className="text-gray-600 mb-6">
                ...
                Curriculum (CBC) and have successfully extended our program through Grade 10, preparing students 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div>
                <p className="font-semibold">Mrs. Catherine Wanjiku</p>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { name: "Mrs. Catherine Wanjiku", position: "Principal", image: "3184360" },
              { name: "Mr. James Mwangi", position: "Deputy Principal", image: "3182743" },
              { name: "Dr. Mary Achieng", position: "Academic Director", image: "3182812" }
            ].map((leader, index) => (
              <div key={index} className="text-center bg-white p-6 rounded-lg shadow-md">
                <img
                  src={`https://images.pexels.com/photos/${leader.image}/pexels-photo-${leader.image}.jpeg?auto=compress&cs=tinysrgb&w=300`}
                  alt={leader.name}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center p-6 bg-white rounded-lg shadow-md">
              ...
              <p className="text-gray-700">KCPE Excellence Rate</p>
            </div>
            <div className="text-center p-6 bg-white rounded-lg shadow-md">
            ...
            <div className="text-center p-6 bg-white rounded-lg shadow-md">
              ...
              <p className="text-gray-700">CBC Implementation</p>
            </div>
          </div>
        </div>
      </section>
