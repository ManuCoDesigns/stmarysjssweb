              ...
              <table className="w-full">
                ...
                <tbody className="divide-y divide-gray-200">
                  {feeStructure.map((fee, index) => (
                    ...
                    >
                      <td className="px-8 py-6 font-semibold text-gray-900 group-hover:text-purple-700">
                        {fee.grade}
                      </td>
            ...
            <div>
              ...
              <div className="space-y-4">
                {requirements.map((requirement, index) => (
                  <div
                    key={index}
                    className="flex items-center p-4 bg-white rounded-xl shadow-sm hover:shadow-md transition-all duration-300 group border border-gray-100 hover:border-purple-200"
                  >
