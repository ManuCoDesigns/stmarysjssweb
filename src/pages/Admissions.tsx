...
function Admissions() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const whatsappNumber = "254714749123";
...
Application submitted on: ${new Date().toLocaleString()}`;
  ...
  const admissionSteps = [
    ...
    },
    {
      ...
      title: "School Visit",
      description:
        "Schedule a visit to tour our facilities and meet with our admissions team",
    ...
    },
    {
      ...
      title: "Assessment",
      description:
        "Student assessment and parent interview (for certain grade levels)",
  ...
  return (
    <div className="overflow-hidden">
      <div className="fixed inset-0 pointer-events-none z-0">
        ...
        <div className="absolute bottom-40 left-20 w-12 h-12 bg-emerald-200 rounded-full opacity-20 animate-pulse"></div>
        <div className="absolute bottom-20 right-10 w-24 h-24 bg-amber-200 rounded-full opacity-20 animate-bounce"></div>
      </div>
      ...
      <section className="relative text-white py-24 overflow-hidden min-h-screen flex items-center">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-cyan-900/80 via-blue-800/70 to-teal-900/80 z-10"></div>

        <div className="absolute inset-0 z-20">
          <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-cyan-600/20 to-transparent"></div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-30">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-cyan-100 max-w-4xl mx-auto leading-relaxed">
              Join our vibrant school community and give your child the
              foundation for a
              <span className="text-yellow-300 font-semibold">
                {" "}
                bright future
              </span>
              . We welcome applications for all grades from Junior School (Grade
              7-9) through Grade 10.
            </p>
            <div className="mt-12 flex flex-wrap justify-center gap-8">
              {achievements.map((achievement, index) => (
                ...
                >
                  <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 mb-2 hover:bg-white/20 transition-all duration-300">
      ...
      <section className="py-24 bg-gradient-to-b from-gray-50 via-white to-cyan-50 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <div className="flex justify-center mb-6">
              <Target className="h-12 w-12 text-cyan-600 animate-pulse" />
            </div>
            ...
            <div className="mt-8 w-24 h-1 bg-gradient-to-r from-cyan-600 to-blue-600 mx-auto rounded-full"></div>
          </div>
            ...
            {admissionSteps.map((step, index) => (
              ...
              >
                {index < admissionSteps.length - 1 && (
                  <div className="hidden lg:block absolute top-16 left-full w-8 h-0.5 bg-gradient-to-r from-cyan-300 to-blue-300 z-10"></div>
                )}

                <div
                  className={`relative p-8 bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border-2 ${
                    activeStep === index
                ...
                >
                  ...
                  <div
                    className={`relative ${step.bgColor} w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300`}
                  >
                  ...
                  <div
                    className={`absolute -top-3 -right-3 bg-gradient-to-r ${step.color} text-white w-10 h-10 rounded-full flex items-center justify-center text-lg font-bold shadow-lg`}
                  >
                    {index + 1}
                  </div>
                  ...
                  <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex justify-center mt-4">
                    <ArrowRight className="h-5 w-5 text-cyan-600 animate-bounce" />
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="py-24 bg-gradient-to-br from-cyan-50 via-blue-50 to-teal-50 relative">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Submit via WhatsApp - Quick & Easy!
            </p>
            <div className="mt-8 w-24 h-1 bg-gradient-to-r from-green-600 to-teal-600 mx-auto rounded-full"></div>
          </div>

          <div className="bg-white/90 backdrop-blur-sm p-10 rounded-3xl shadow-2xl border-2 border-cyan-100">
            {submitStatus === "success" && (
              <div className="mb-8 p-6 bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-300 rounded-2xl transform animate-pulse">
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="text-green-800 font-semibold text-lg">
                      Application opened in WhatsApp! 🎉
                    </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="group">
                  ...
                  <input
                    ...
                    className="w-full px-6 py-4 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-4 focus:ring-cyan-100 focus:border-cyan-500 transition-all duration-300 bg-white/50 backdrop-blur-sm group-hover:border-cyan-300"
              ...
              <div className="group">
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  className="w-full px-6 py-4 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-4 focus:ring-cyan-100 focus:border-cyan-500 transition-all duration-300 bg-white/50 backdrop-blur-sm group-hover:border-cyan-300 resize-none"
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-green-500 via-emerald-600 to-teal-600 text-white py-5 px-8 rounded-xl font-bold text-lg hover:from-green-600 hover:via-emerald-700 hover:to-teal-700 focus:outline-none focus:ring-4 focus:ring-green-300 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 flex items-center justify-center group shadow-lg hover:shadow-xl transform hover:scale-[1.02]"
              >
                {isSubmitting ? (
                  <>
                  ...
                  <>
                    <MessageCircle className="h-6 w-6 mr-3 group-hover:translate-x-1 transition-transform duration-300" />
                    Submit via WhatsApp
              ...
              <div className="text-center space-y-2">
                <p className="text-sm text-gray-600 flex items-center justify-center">
                  ...
                  Application will open in WhatsApp for direct submission
                </p>
      ...
      <section className="py-24 bg-gradient-to-br from-white via-blue-50 to-cyan-50 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="flex justify-center mb-6">
              <DollarSign className="h-12 w-12 text-emerald-600 animate-pulse" />
            </div>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Fee Structure
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Transparent and affordable education fees
            </p>
              ...
              <table className="w-full">
                ...
                <tbody className="divide-y divide-cyan-100">
                  {feeStructure.map((fee, index) => (
                    ...
                    >
                      <td className="px-8 py-6 font-semibold text-gray-900 group-hover:text-cyan-700">
                        {fee.grade}
                      </td>
                      ...
                      <td className="px-8 py-6 text-gray-700 font-bold text-lg">
                        {fee.yearFee}
                      </td>
                    </tr>
                  ))}
          ...
          <div className="mt-12 bg-gradient-to-r from-emerald-50 to-teal-50 p-8 rounded-2xl border-2 border-emerald-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <ul className="text-gray-700 space-y-3">
                ...
                <li className="flex items-center">
                  <CheckCircle className="h-5 w-5 text-emerald-500 mr-3" />
                  Registration fee: KES 1,000 (one-time payment)
                </li>
                <li className="flex items-center">
                  <CheckCircle className="h-5 w-5 text-emerald-500 mr-3" />
      ...
      <section className="py-24 bg-gradient-to-br from-gray-50 via-cyan-50 to-blue-50 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div>
              <div className="flex items-center mb-8">
                <FileText className="h-10 w-10 text-cyan-600 mr-4" />
              ...
              <div className="space-y-4">
                {requirements.map((requirement, index) => (
                  <div
                    key={index}
                    className="flex items-center p-4 bg-white rounded-xl shadow-sm hover:shadow-md transition-all duration-300 group border-2 border-gray-100 hover:border-cyan-200"
                  >
                    <div className="bg-cyan-100 rounded-lg p-2 mr-4 group-hover:bg-cyan-200 transition-colors duration-300">
                      <requirement.icon className="h-5 w-5 text-cyan-600" />
                    </div>
                    <span className="text-gray-700 font-medium group-hover:text-cyan-700 transition-colors duration-300">
                      {requirement.text}
                    </span>
                  </div>
                ))}
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-center p-6 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 group border-2 border-gray-100 hover:border-blue-200">
                ...
                <div className="flex items-center p-6 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 group border-2 border-gray-100 hover:border-emerald-200">
                  <div className="bg-emerald-100 rounded-xl p-3 mr-6 group-hover:bg-emerald-200 transition-colors duration-300">
                ...
                <div className="flex items-center p-6 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 group border-2 border-gray-100 hover:border-orange-200">
      ...
      <section className="py-24 bg-gradient-to-br from-cyan-900 via-blue-800 to-teal-900 text-white relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-cyan-100 max-w-4xl mx-auto leading-relaxed">
              Our Grade 10 program offers specialized pathways to prepare
              students for university entrance and career success.
            </p>
            ...
            {[
              {
                title: "STEM Pathway",
                description:
                  "Advanced mathematics, sciences, and technology preparation for engineering and medical programs.",
                icon: Zap,
                color: "from-blue-500 to-cyan-500",
                subjects: [
              ...
              },
              {
                ...
                description:
                  "Literature, languages, and social sciences for law, journalism, and teaching careers.",
                icon: BookOpen,
              ...
              },
              {
                ...
                description:
                  "Commerce, economics, and entrepreneurship for business and finance careers.",
                icon: Trophy,
              ...
              <div key={index} className="group">
                <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl hover:bg-white/20 transition-all duration-300 border-2 border-white/20 hover:border-white/40 transform hover:scale-105">
                  <div
                    className={`bg-gradient-to-r ${pathway.color} w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300`}
                  >
