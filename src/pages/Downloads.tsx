...
const Downloads = () => {
  ...
  const quickAccessItems = [
    { title: "Admission Form", category: "Admissions", icon: "📝", fileId: 1, gradient: "from-blue-500 to-blue-600" },
    { title: "Fee Structure", category: "Finance", icon: "💰", fileId: 2, gradient: "from-emerald-500 to-emerald-600" },
    { title: "Academic Calendar", category: "Academic", icon: "📅", fileId: 3, gradient: "from-purple-500 to-purple-600" },
    { title: "Parent Handbook", category: "General", icon: "📖", fileId: 8, gradient: "from-amber-500 to-amber-600" }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-amber-50 to-orange-50">
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-block mb-6 px-6 py-2 glass-effect rounded-full animate-fade-in-up">
            <span className="text-white font-semibold text-sm tracking-wide">📚 RESOURCE CENTER</span>
          </div>
          <h1 
          ...
          >
            Access all school documents, forms, policies, and academic resources in one convenient location
          </p>
          <div 
      ...
      <section 
        ...
        style={{
          background: 'linear-gradient(to right, rgba(255,255,255,0.95) 0%, rgba(254,243,199,0.95) 50%, rgba(255,255,255,0.95) 100%)',
            ...
            <div className="relative flex-1 max-w-xl w-full">
              <input
                ...
                onBlur={(e) => {
                  ...
                  e.target.style.boxShadow = '0 10px 30px -10px rgba(245,158,11,0.2)';
                }}
              />
              <Search 
          ...
          {filteredFiles.length > 0 ? (
              ...
              {filteredFiles.map((file, index) => (
                ...
                >
                  <div className="p-8">
                    <div className="flex items-start justify-between mb-5">
                      <div className="flex items-center space-x-4">
                        <div 
                          ...
                          onMouseEnter={(e) => {
                            e.currentTarget.style.transform = 'scale(1.3) rotate(12deg)';
                          }}
                          onMouseLeave={(e) => {
                        ...
                        <span className={`px-4 py-1.5 rounded-full text-xs font-bold border-2 ${getCategoryColor(file.category)}`}>
                          {file.category}
                        </span>
                      </div>
                      <span 
                    ...
                    >
                      <div className="flex items-center space-x-4">
                        <span className="font-bold text-amber-700">{file.size}</span>
                    ...
                    <div className="flex gap-3">
                      ...
                      <button
                        ...
                        onMouseLeave={(e) => {
                          e.currentTarget.style.transform = 'scale(1)';
                          e.currentTarget.style.boxShadow = '0 4px 15px rgba(71,85,105,0.2)';
                        }}
                        title="Preview file"
                      >
                  ...
                  <div 
                    style={{
                      height: '4px',
                      background: 'linear-gradient(to right, #f59e0b 0%, #ea580c 50%, #dc2626 100%)',
                    }}
                  />
                </div>
              ))}
            ...
            >
              ...
              <button
                ...
                onMouseEnter={(e) => e.currentTarget.style.boxShadow = '0 8px 25px rgba(245,158,11,0.4)'}
                onMouseLeave={(e) => e.currentTarget.style.boxShadow = '0 4px 15px rgba(245,158,11,0.3)'}
              >
                Clear filters
              </button>
            </div>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            >
              <span className="text-amber-700 font-bold text-sm tracking-wide">⚡ QUICK ACCESS</span>
            </div>
            <h2 className="text-5xl font-black text-gray-900 mb-6">Popular Downloads</h2>
            <p className="text-2xl text-gray-700 max-w-2xl mx-auto">Most frequently accessed documents by our community</p>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <p className="text-gray-600 text-sm mb-6 font-medium">{item.category}</p>
      ...
      <section 
        ...
        style={{
          background: 'linear-gradient(135deg, #1e293b 0%, #92400e 50%, #ea580c 100%)',
        }}
      >
        <div 
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-black mb-4">Trusted by Our Community</h2>
            <p className="text-xl text-amber-200">Real-time statistics from our downloads center</p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              >
                ...
                <div className="text-sm text-amber-200 font-semibold">{stat.label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      >
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="text-5xl font-black text-white mb-6" style={{ textShadow: '0 4px 20px rgba(0,0,0,0.3)' }}>
            Need Assistance?
          </h2>
          <p className="text-2xl text-white/95 mb-10 leading-relaxed max-w-3xl mx-auto">
            Can't find the document you're looking for? Our dedicated office staff is here to help you every step of the way.
          </p>
        ...
        >
          ...
          >
            <div 
              ...
              style={{
                background: 'linear-gradient(to right, #fef3c7 0%, #fed7aa 100%)',
                borderBottom: '2px solid #fbbf24',
              }}
            >
              <div>
                <h2 className="text-3xl font-black text-gray-900 mb-2">{previewFile.title}</h2>
                <p className="text-gray-600 text-sm">{previewFile.description}</p>
              </div>
              <button
              ...
              {getEmbedUrl(previewFile.url) ? (
                ...
                <div className="w-full h-full flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-gray-600 text-2xl font-bold">Preview not available</p>
            ...
            >
              ...
              <button
                ...
                onMouseEnter={(e) => {
                  ...
                  e.currentTarget.style.boxShadow = '0 15px 40px rgba(71,85,105,0.3)';
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.transform = 'scale(1)';
                  e.currentTarget.style.backgroundColor = '#e2e8f0';
                  e.currentTarget.style.boxShadow = '0 10px 30px rgba(71,85,105,0.2)';
                }}
              >
                Close Preview
              </button>
